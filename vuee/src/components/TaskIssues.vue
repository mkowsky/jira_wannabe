        ...
        <div style="display: flex; justify-content: center; width: 100%;">
            <div v-if="!(taskIssues.length > 0)" style="display: flex; flex-direction: row;  width: 100%;">
                <div style="width: 50%; display: flex; flex-direction: column">
                    <div style="background: #6C63FF; padding: 10px; font-size: 50px; margin-bottom: 20px; text-align: center">TASK ISSUES</div>
                    <div style="font-size: 44px; font-weight: 800; text-align: center; margin-bottom: 30px;">THERE IS NO ISSUES ASSIGNED TO THIS TASK</div>
                    <div style="font-size: 36px; text-align: center; font-style: italic; opacity: 0.8; margin-bottom: 80px;">If anyone will report issue with this task, it will be displayed in this place.</div>
                    <v-btn rounded x-large style="align-self: center" color="#6C63FF" @click="reportIssue">REPORT ISSUE</v-btn>
                </div>

                <div style="width: 50%;">
                    <img src="../assets/undraw_fixing_bugs_w7gi.svg" style="width: 100%; height: 100%;">
                </div>
            </div>
            ...
            <div v-if="taskIssues.length > 0" style="display: flex; flex-direction: row; width: 100%; ">
                ...
                <div style="display: flex; flex-direction: column; width: 60%; ">
                   <div>
                    ...
                    <div v-if="issuePicked" style="background: white; box-shadow: 0 0 10px black; align-self: center; transition: 0.7s; height: 100%; width: 900px; display: flex;">
                        <div style="padding: 20px; width: 60%; display: flex; flex-direction: column;">
                            ...
                            <div style="font-size: 32px; font-weight: 500; opacity: 0.8; margin-bottom: 10px;">DESCRIPTION</div>
                            <div style="margin-bottom: 10px; font-size: 18px; font-style: italic">{{currentIssue.issueDescription}}</div>
                            <div style="font-size: 32px; font-weight: 500; opacity: 0.8; margin-bottom: 10px;">ACITONS</div>
                            <div><v-btn color="#6C63FF" large>CLOSE ISSUE</v-btn></div>
                        </div>
                        <div style="display: flex; flex-direction: column; width: 40%; justify-content: flex-end; align-items: center; padding: 10px; ">
                            ...
                            <div style="color: #6C63FF; font-weight: 700; font-size: 32px;">{{currentIssue.issueKEY}}</div>
                            <img src="../assets/undraw_collecting_fjjl.svg" style="width: 100%; height: 80%;">
                        </div>
                    </div>

                    <div v-if="!issuePicked" style="display: flex; flex-direction: column; width: 50%; ">

                            <img src="../assets/undraw_Questions_re_1fy7.svg"
